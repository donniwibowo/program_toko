				...
				.on('xchange.xdsoft', function (event) {
					...
					xchangeTimer = setTimeout(function () {
						...
						line_time = function line_time(h, m) {
							...
							classes = [];                            
							if ((options.minDateTime !== false && options.minDateTime > optionDateTime) || (options.maxTime !== false && _xdsoft_datetime.strtotime(options.maxTime).getTime() < now.getTime()) || (options.minTime !== false && now.getTime() < options.minTime.getTime())) {
								classes.push('xdsoft_disabled');
